...
<head>
        ...
        <title>PTO - Administrator Login</title>
        ...
        <!-- Animo css-->
        <link href="<?php echo base_url(); ?>plugins/animo/animate+animo.css" rel="stylesheet" media="screen">
        ...
        <!-- Load jQuery -->
        <script src="<?php echo base_url(); ?>assets/js/jquery.v2.0.3.js"s"></script>
